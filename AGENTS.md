...
This is a Rust client library for the [sportdb.dev](https://sportdb.dev) API, which surfaces
live sports data (competitions, fixtures, results, standings, live odds, match events/stats/
lineups, players, and teams) sourced from Flashscore.

The crate is published to [crates.io](https://crates.io/crates/sportdbdev) and documented on
[docs.rs](https://docs.rs/sportdbdev).

## Repository

- **GitHub**: https://github.com/pilgrimagesoftware/sportdbdev.rs
- **Crate name**: `sportdbdev`
...
- Commit messages follow the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/)
  format, e.g. `feat(competition): add list-fixtures endpoint` — `git-cliff` reads these to
  generate the changelog and compute the release version; see [RELEASING.md](RELEASING.md).
